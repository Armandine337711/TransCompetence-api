...
UPDATE "financial_datas" SET
    ...
    "loading_unit_id" = updatedDatas ->>'loading_unit_id',
...
CREATE FUNCTION "dp2_update"(ujpdatedDatas json) RETURNS SETOF 'financial_datas' AS
$$
UPDATE "financial_datas" SET
...
CREATE FUNCTION "dp3_update"(ujpdatedDatas json) RETURNS SETOF 'financial_datas' AS
$$
UPDATE "financial_datas" SET
...
CREATE FUNCTION "dp4_update"(ujpdatedDatas json) RETURNS SETOF 'financial_datas' AS
$$
UPDATE "financial_datas" SET
  "duration_motor_vehicle_use" = (updatedDatas ->>'duration_motor_vehicle_use')::float,
  "mv_financial_method_id" =(updatedDatas ->>'mv_financial_method_id')::int
...
CREATE FUNCTION "dp5_update"(ujpdatedDatas json) RETURNS SETOF 'financial_datas' AS
$$
UPDATE "financial_datas" SET
   "duration_towed_vehicle" = (updatedDatas ->>'duration_towed_vehicle')::float,
  "tv_financial_method_id" =(updatedDatas ->>'mv_financial_method_id')::int
...
CREATE FUNCTION "dp6_update"(ujpdatedDatas json) RETURNS SETOF 'financial_datas' AS6
$$
UPDATE "financial_datas" SET
...
CREATE FUNCTION "dp7_update"(ujpdatedDatas json) RETURNS SETOF 'financial_datas' AS
$$
UPDATE "financial_datas" SET
